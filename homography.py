...
class homography():
    ...
    def get_h(self):
        ...
        for i in range(len(aMatches)):
            ...
            matches.append(cv2.DMatch( i, i ,i, 0.001 ))

        print("len matches", len(matches))
        print("len keypoints1", len(self.keypoints1))
        print("len keypoints2", len(self.keypoints2))
        ...
        plt.imsave("output_images/manual_correspondences.png", img3)
